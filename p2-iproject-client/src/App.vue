    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm mb-12 fixed-top">
      <div class="container">
        <a class="navbar-brand">
          <img
            src="https://images.unsplash.com/photo-1534226501678-2988ac084d54?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Ym9vayUyMGljb258ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class=navbar-nav>
            ...
            <b-dropdown id="dropdown-left" text="Category" variant="primary" size="lg"
                        v-if="$route.name!='Home' && $route.name!='Error404'">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <router-link class="nav-link btn-info text-dark fs-5 me-3" to="/login"
                           v-if="!isLogin && $route.name!='Login'">Login
              </router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link btn-info text-dark fs-5" to="/register"
                           v-if="!isLogin && $route.name!='Register'">Register
              </router-link>
            </li>
            <li class="nav-item">
